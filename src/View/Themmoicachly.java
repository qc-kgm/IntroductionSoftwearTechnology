...
//	}
	...
	public Themmoicachly() {
		...
		txthoten.setBounds(235, 99, 288, 36);
		...
		txtid.setColumns(10);
		txtid.setBounds(235, 193, 288, 36);
		...
		btnSave.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				int j=ttkhaibao_mt.InsertorUpdatecachly(ex,ex2);
				if(j==1) {
